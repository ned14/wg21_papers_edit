...
\begin{itemize}
    ...
    \item Fix uses of a free function \code{render_zero_terminated()} to be member functions
    \item Clarify the lifetime semantics of \code{rendered_path}
    \item Removed named type requirements and respecified \code{path_view}-accepting overloads in terms of \emph{path-view-like} (based on techniques used in P1928R4)
...
\tsreplace{}{}{+ \code{  explicit basic_fstream(\emph{path-view-like} s,
ios_base::openmode mode = ios_base::in);}}
...
\tsreplace{}{}{+ \code{void copy(\emph{path-view-like} from, \emph{path-view-like} to);}}\\
\tsreplace{}{}{+ \code{void copy(\emph{path-view-like} from, \emph{path-view-like} to, error_code& ec);}}
...
\tsreplace{}{}{+ \code{void copy(\emph{path-view-like} from, \emph{path-view-like} to, copy_options options);}}\\
\tsreplace{}{}{+ \code{void copy(\emph{path-view-like} from, \emph{path-view-like} to, copy_options options, error_code& ec);}}
...
\tsreplace{}{}{+ \code{bool copy_file(\emph{path-view-like} from, \emph{path-view-like} to);}}\\
\tsreplace{}{}{+ \code{bool copy_file(\emph{path-view-like} from, \emph{path-view-like} to, error_code& ec);}}
...
\tsreplace{}{}{+ \code{bool copy_file(\emph{path-view-like} from, \emph{path-view-like} to, copy_options options);}}\\
\tsreplace{}{}{+ \code{bool copy_file(\emph{path-view-like} from, \emph{path-view-like} to, copy_options options, error_code& ec);}}
...
\tsreplace{}{}{+ \code{void copy_symlink(\emph{path-view-like} existing\_symlink, \emph{path-view-like} new\_symlink);}}\\
\tsreplace{}{}{+ \code{void copy_symlink(\emph{path-view-like} existing\_symlink, \emph{path-view-like} new\_symlink, error_code& ec);}}
...
\tsreplace{}{}{+ \code{bool create_directory(\emph{path-view-like} p, \emph{path-view-like} attributes);}}\\
\tsreplace{}{}{+ \code{bool create_directory(\emph{path-view-like} p, \emph{path-view-like} attributes, error_code& ec);}}
...
\tsreplace{}{}{+ \code{void create_directory_symlink(\emph{path-view-like} to, \emph{path-view-like} new_symlink);}}\\
\tsreplace{}{}{+ \code{void create_directory_symlink(\emph{path-view-like} to, \emph{path-view-like} new_symlink, error_code& ec);}}
...
\tsreplace{}{}{+ \code{void create_hard_link(\emph{path-view-like} to, \emph{path-view-like} new_hard_link);}}\\
\tsreplace{}{}{+ \code{void create_hard_link(\emph{path-view-like} to, \emph{path-view-like} new_hard_link, error_code& ec);}}
...
\tsreplace{}{}{+ \code{void create_symlink(\emph{path-view-like} to, \emph{path-view-like} new_symlink);}}\\
\tsreplace{}{}{+ \code{void create_symlink(\emph{path-view-like} to, \emph{path-view-like} new_symlink, error_code& ec);}}
...
\tsreplace{}{}{+ \code{bool equivalent(\emph{path-view-like} p1, \emph{path-view-like} p2);}}\\
\tsreplace{}{}{+ \code{bool equivalent(\emph{path-view-like} p1, \emph{path-view-like} p2, error_code& ec);}}
...
\tsreplace{}{  \code{path proximate(const path& p, \emph{path-view-like} base = current_path());}}{}\\
\tsreplace{}{  \code{path proximate(const path& p, \emph{path-view-like} base, error_code& ec);}}{}\\
\tsreplace{}{}{+ \code{path proximate(\emph{path-view-like} p, error_code& ec);}}\\
\tsreplace{}{}{+ \code{path proximate(\emph{path-view-like} p, \emph{path-view-like} base = current_path());}}\\
\tsreplace{}{}{+ \code{path proximate(\emph{path-view-like} p, \emph{path-view-like} base, error_code& ec);}}
...
\tsreplace{}{}{+ \code{path relative(\emph{path-view-like} p, \emph{path-view-like} base = current_path());}}\\
\tsreplace{}{}{+ \code{path relative(\emph{path-view-like} p, \emph{path-view-like} base, error_code& ec);}}
...
\tsreplace{}{}{+ \code{void rename(\emph{path-view-like} from, \emph{path-view-like} to);}}\\
\tsreplace{}{}{+ \code{void rename(\emph{path-view-like} from, \emph{path-view-like} to, error_code& ec);}}
...
\tsreplace{}{}{+ \code{friend path operator/ (\emph{path-view-like} lhs, \emph{path-view-like} rhs);}}
...
and which has a single exposition-only member \code{\emph{view}} of type \code{path_view} which is initialized from the object of type \code{T}.

\subsection*{Class \code{path_view_component} [fs.path\_view\_component]}

An object of class \code{path_view_component} refers to a source of data from which a filesystem path can be derived. To avoid confusion, in the remainder of this section this source of data shall be called \emphh{the backing data}.
