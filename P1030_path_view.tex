...
\begin{itemize}
    ...
    returns \code{native_format}.
    \item Use \emph{Returns} instead of \emph{Effects: As if} in overloads in [filebuf]
    \item Fix uses of a free function \code{render_zero_terminated()} to be member functions
    \item Clarify the lifetime semantics of \code{rendered_path}
    \item Removed named type requirements and respecified \code{path_view}-accepting overloads in terms of \code{\emp{path-view-like}} (based on techniques used in P1928R4)
    \end{itemize}
...
\tsreplace{}{}{+ \code{basic_filebuf* open(\emp{path-view-like} s, ios_base::openmode mode);}}
...
\tsreplace{}{}{+ \code{explicit basic_ifstream(\emp{path-view-like} s,
ios_base::openmode mode = ios_base::in);}}

\tsreplace{}{}{+ \code{void open(\emp{path-view-like} s, ios_base::openmode mode = ios_base::in);}}
...
\tsreplace{}{}{+ \code{explicit basic_fstream(\emp{path-view-like} s, ios_base::openmode mode = ios_base::in | ios_base::out);}}

\tsreplace{}{}{+ \code{void open(\emp{path-view-like} s, ios_base::openmode mode = ios_base::in | ios_base::out);}}
...
\tsreplace{}{}{+ \code{path absolute(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{path absolute(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{path canonical(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{path canonical(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{void copy(\emp{path-view-like} from, \emp{path-view-like} to);}}

\tsreplace{}{}{+ \code{void copy(\emp{path-view-like} from, \emp{path-view-like} to, error_code& ec);}}

\tsreplace{}{}{+ \code{void copy(\emp{path-view-like} from, \emp{path-view-like} to, copy_options options);}}

\tsreplace{}{}{+ \code{void copy(\emp{path-view-like} from, \emp{path-view-like} to, copy_options options, error_code& ec);}}

\tsreplace{}{}{+ \code{bool copy_file(\emp{path-view-like} from, \emp{path-view-like} to);}}

\tsreplace{}{}{+ \code{bool copy_file(\emp{path-view-like} from, \emp{path-view-like} to, error_code& ec);}}

\tsreplace{}{}{+ \code{bool copy_file(\emp{path-view-like} from, \emp{path-view-like} to, copy_options options);}}

\tsreplace{}{}{+ \code{bool copy_file(\emp{path-view-like} from, \emp{path-view-like} to, copy_options options, error_code& ec);}}

\tsreplace{}{}{+ \code{void copy_symlink(\emp{path-view-like} existing\_symlink, \emp{path-view-like} new\_symlink);}}

\tsreplace{}{}{+ \code{void copy_symlink(\emp{path-view-like} existing\_symlink, \emp{path-view-like} new\_symlink, error_code& ec);}}

\tsreplace{}{}{+ \code{bool create_directories(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{bool create_directories(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{bool create_directory(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{bool create_directory(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{bool create_directory(\emp{path-view-like} p, \emp{path-view-like} attributes);}}

\tsreplace{}{}{+ \code{bool create_directory(\emp{path-view-like} p, \emp{path-view-like} attributes, error_code& ec);}}

\tsreplace{}{}{+ \code{void create_directory_symlink(\emp{path-view-like} to, \emp{path-view-like} new_symlink);}}

\tsreplace{}{}{+ \code{void create_directory_symlink(\emp{path-view-like} to, \emp{path-view-like} new_symlink, error_code& ec);}}

\tsreplace{}{}{+ \code{void create_hard_link(\emp{path-view-like} to, \emp{path-view-like} new_hard_link);}}

\tsreplace{}{}{+ \code{void create_hard_link(\emp{path-view-like} to, \emp{path-view-like} new_hard_link, error_code& ec);}}

\tsreplace{}{}{+ \code{void create_symlink(\emp{path-view-like} to, \emp{path-view-like} new_symlink);}}

\tsreplace{}{}{+ \code{void create_symlink(\emp{path-view-like} to, \emp{path-view-like} new_symlink, error_code& ec);}}

\tsreplace{}{}{+ \code{void current_path(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{void current_path(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{bool equivalent(\emp{path-view-like} p1, \emp{path-view-like} p2);}}

\tsreplace{}{}{+ \code{bool equivalent(\emp{path-view-like} p1, \emp{path-view-like} p2, error_code& ec);}}

\tsreplace{}{}{+ \code{bool exists(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{bool exists(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{uintmax_t file_size(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{uintmax_t file_size(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{uintmax_t hard_link_count(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{uintmax_t hard_link_count(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{bool is_block_file(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{bool is_block_file(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{bool is_character_file(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{bool is_character_file(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{bool is_directory(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{bool is_directory(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{bool is_empty(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{bool is_empty(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{bool is_fifo(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{bool is_fifo(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{bool is_other(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{bool is_other(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{bool is_regular_file(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{bool is_regular_file(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{bool is_socket(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{bool is_socket(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{bool is_symlink(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{bool is_symlink(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{file_time_type last_write_time(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{file_time_type last_write_time(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{void last_write_time(\emp{path-view-like} p, file_time_type new_time);}}

\tsreplace{}{}{+ \code{void last_write_time(\emp{path-view-like} p, file_time_type new_time, error_code& ec);}}

\tsreplace{}{}{+ \code{void permissions(\emp{path-view-like} p, perms prms, perm_options opts=perm_options::replace);}}

\tsreplace{}{}{+ \code{void permissions(\emp{path-view-like} p, perms prms, error_code& ec);}}

\tsreplace{}{}{+ \code{void permissions(\emp{path-view-like} p, perms prms, perm_options opts,  error_code& ec);}}

\tsreplace{}{}{+ \code{path proximate(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{path proximate(\emp{path-view-like} p, \emp{path-view-like} base = current_path());}}

\tsreplace{}{}{+ \code{path proximate(\emp{path-view-like} p, \emp{path-view-like} base, error_code& ec);}}

\tsreplace{}{}{+ \code{path read_symlink(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{path read_symlink(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{path relative(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{path relative(\emp{path-view-like} p, \emp{path-view-like} base = current_path());}}

\tsreplace{}{}{+ \code{path relative(\emp{path-view-like} p, \emp{path-view-like} base, error_code& ec);}}

\tsreplace{}{}{+ \code{bool remove(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{bool remove(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{uintmax_t remove_all(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{uintmax_t remove_all(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{void rename(\emp{path-view-like} from, \emp{path-view-like} to);}}

\tsreplace{}{}{+ \code{void rename(\emp{path-view-like} from, \emp{path-view-like} to, error_code& ec);}}

\tsreplace{}{}{+ \code{void resize_file(\emp{path-view-like} p, uintmax_t size);}}

\tsreplace{}{}{+ \code{void resize_file(\emp{path-view-like} p, uintmax_t size, error_code& ec);}}

\tsreplace{}{}{+ \code{space_info space(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{space_info space(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{file_status status(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{file_status status(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{file_status symlink_status(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{file_status symlink_status(\emp{path-view-like} p, error_code& ec);}}

\tsreplace{}{}{+ \code{path weakly_canonical(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{path weakly_canonical(\emp{path-view-like} p, error_code& ec);}}


\tsrefp{fs.class.path}{29.12.6}{6}

\tsreplace{}{}{+ \code{explicit path(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{path(\emp{path-view-like} p, const locale& loc);}}

\tsreplace{}{}{+ \code{path& operator=(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{path& assign(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{path& operator/=(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{path& operator+=(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{format formatting() const noexcept { return format::native_format; }}}

\tsreplace{}{}{+ \code{path& replace_filename(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{path& replace_extension(\emp{path-view-like} p);}}

\tsreplace{}{}{+ \code{friend path operator/ (const path\& lhs, \emp{path-view-like} rhs);}}
...
\tsreplace{}{}{+ \code{friend path operator/ (path&& lhs, \emp{path-view-like} rhs);}}

\tsreplace{}{}{+ \code{friend path operator/ (\emp{path-view-like} lhs, \emp{path-view-like} rhs);}}

\tsreplace{}{}{+ \code{int compare(\emp{path-view-like} p) const;}}

\tsreplace{}{}{+ \code{path lexically_relative(\emp{path-view-like} p) const;}}

\tsreplace{}{}{+ \code{path lexically_proximate(\emp{path-view-like} p) const;}}
...
and which has a single exposition-only member \code{\emp{view}} of type \code{path_view} which is initialized from the object of type \code{T}.
