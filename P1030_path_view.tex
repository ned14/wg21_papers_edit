...
\tsreplace{}{}{+ \effects As if \code{open(render_null_terminated(path_view(forward<T&&>(s))).c_str(), mode);}}
...
\tsreplace{}{}{+ \effects As if \code{basic_ifstream(render_null_terminated(path_view(forward<T&&>(s))).c_str(), mode);}}
...
\tsreplace{}{}{+ \effects As if \code{basic_ofstream(render_null_terminated(path_view(forward<T&&>(s))).c_str(), mode);}}
...
\tsreplace{}{}{+ \effects As if \code{basic_fstream(render_null_terminated(path_view(forward<T&&>(s))).c_str(), mode);}}
...
namespace std::filesystem {
  ...
  public:
    ...
    render_null_terminated(path_view_component v,
                           const locale& loc,
    ...
    constexpr rendered_path<zero_termination::not_zero_terminated,
                            T, Allocator, _internal_buffer_size>
    render_unterminated(path_view_component v,
                               const locale& loc,
                               Allocator allocate = Allocator());
    template <class T = typename path::value_type,
              class Allocator = default_rendered_path_allocator<T>,
