...
\tsreplace{}{}{+ \code{\}; }}\\
\tsreplace{}{}{+ \code{path \emph{path-from-binary}(span<const byte> data); // exposition-only}}\\
...
+ The exposition-only function \code{\emph{path-from-binary}} returns a \code{path} constructed from a \code{span<const byte>}.\\
